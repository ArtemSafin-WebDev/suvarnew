...
export default function boxroomsProject() {
    const elements = Array.from(document.querySelectorAll<HTMLElement>(".boxrooms-project"));
    ...
    elements.forEach((element) => {
        ...
        const listItems = element.querySelectorAll<HTMLElement>(".boxrooms-project__table-list-item");
        ...
        if (mediaQuery.matches) {
            ...
            listItems.forEach((listItem) => {
                const contentWrapper = listItem.querySelector<HTMLElement>(".boxrooms-project__table-card-content-wrapper");
                ...
                const backButton = listItem.querySelector<HTMLButtonElement>(".boxrooms-project__table-card-content-button-back");
        ...
        function handleAccordionClick(clickedElement: HTMLElement) {
            if (clickedElement.closest<HTMLElement>(".boxrooms-project__table-list-item")?.classList.contains("active")) {
                clickedElement.closest<HTMLElement>(".boxrooms-project__table-list-item")?.classList.remove("active");
                return;
            }

            const allItems = element.querySelectorAll<HTMLElement>(".boxrooms-project__table-list-item");
            allItems.forEach(item => item.classList.remove("active"));

            const listItem = clickedElement.closest<HTMLElement>(".boxrooms-project__table-list-item");
            if (listItem) {
                listItem.classList.add("active");
        ...
        function setupZoomAndDrag(container: HTMLElement) {
            const contentContainer = container.querySelector<HTMLDivElement>(".boxrooms-project__image-draggable");
            const decreaseButton = container.querySelector<HTMLButtonElement>(".boxrooms-project__decrease");
            const increaseButton = container.querySelector<HTMLButtonElement>(".boxrooms-project__increase");
        ...
        const allFiltersModal = element.querySelector<HTMLElement>(".boxrooms-project__all-filters-modal");
        const fixedShowFilters = element.querySelector<HTMLButtonElement>(".boxrooms-project__fixed-show-filters");

        const sortSelects = Array.from(element.querySelectorAll<HTMLElement>(".boxrooms-project__sort"));
        ...
        const moreButtons = element.querySelectorAll<HTMLButtonElement>(".boxrooms-project__more");
        ...
        function openMoreModal(moreButton: HTMLButtonElement) {
            const listItem = moreButton.closest<HTMLElement>(".boxrooms-project__table-list-item");
            if (!listItem) return;
            ...
            const price = listItem.querySelector<HTMLElement>(".boxrooms-project__table-card-content-price");
            const options = listItem.querySelector<HTMLElement>(".boxrooms-project__table-card-content-options");
            ...
            const orderCallButton = listItem.querySelector<HTMLElement>(".boxrooms-project__order-call");
            if (orderCallButton) {
