...
export default function boxroomsHouse() {
    const elements = Array.from(document.querySelectorAll<HTMLElement>(".boxrooms-house"));
    ...
    elements.forEach((element) => {
        ...
        const listItems = element.querySelectorAll<HTMLElement>(".boxrooms-house__table-list-item");
        ...
        if (mediaQuery.matches) {
            ...
            listItems.forEach((listItem) => {
                const contentWrapper = listItem.querySelector<HTMLElement>(".boxrooms-house__table-card-content-wrapper");
                ...
                const backButton = listItem.querySelector<HTMLButtonElement>(".boxrooms-house__table-card-content-button-back");
        ...
        function handleAccordionClick(clickedElement: HTMLElement) {
            if (clickedElement.closest<HTMLElement>(".boxrooms-house__table-list-item")?.classList.contains("active")) {
                clickedElement.closest<HTMLElement>(".boxrooms-house__table-list-item")?.classList.remove("active");
                return;
            }

            const allItems = element.querySelectorAll<HTMLElement>(".boxrooms-house__table-list-item");
            allItems.forEach(item => item.classList.remove("active"));

            const listItem = clickedElement.closest<HTMLElement>(".boxrooms-house__table-list-item");
            if (listItem) {
                listItem.classList.add("active");
        ...
        function setupZoomAndDrag(container: HTMLElement) {
            const contentContainer = container.querySelector<HTMLDivElement>(".boxrooms-house__image-draggable");
            const decreaseButton = container.querySelector<HTMLButtonElement>(".boxrooms-house__decrease");
            const increaseButton = container.querySelector<HTMLButtonElement>(".boxrooms-house__increase");
        ...
        const allFiltersModal = element.querySelector<HTMLElement>(".boxrooms-house__all-filters-modal");
        const fixedShowFilters = element.querySelector<HTMLButtonElement>(".boxrooms-house__fixed-show-filters");

        const sortSelects = Array.from(element.querySelectorAll<HTMLElement>(".boxrooms-house__sort"));
        ...
        const moreButtons = element.querySelectorAll<HTMLButtonElement>(".boxrooms-house__more");
        ...
        function openMoreModal(moreButton: HTMLButtonElement) {
            const listItem = moreButton.closest<HTMLElement>(".boxrooms-house__table-list-item");
            if (!listItem) return;

            // Создаем попап
            const modal = document.createElement("div");
            modal.classList.add("boxrooms-house__modal-more");

            const modalWrapper = document.createElement("div");
            modalWrapper.classList.add("boxrooms-house__modal-more-wrapper");
            modal.appendChild(modalWrapper);


            // Добавляем контент в попап
            const title = listItem.querySelector<HTMLElement>(".boxrooms-house__table-card-content-title");
            const price = listItem.querySelector<HTMLElement>(".boxrooms-house__table-card-content-price");
            const options = listItem.querySelector<HTMLElement>(".boxrooms-house__table-card-content-options");
            ...
            closeButton.classList.add("boxrooms-house__modal-more-close", "js-close-modal-mores");
            ...
            const orderCallButton = listItem.querySelector<HTMLElement>(".boxrooms-house__order-call");
            if (orderCallButton) {
